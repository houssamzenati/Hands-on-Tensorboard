...
x = tf.placeholder(tf.float32, shape=[None,28*28]) #placeholder for the input image
y = tf.placeholder(tf.float32, shape=[None,10]) #placeholder for the input random vector
